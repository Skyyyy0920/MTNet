...
class TreeLSTM(nn.Module):
    def __init__(self,
        ...
        self.nary = nary
        # embedding
        self.embedding_dim = POI_embed_dim
        self.fuse_len = num_POIs + num_cats + num_coos + num_users
    ...
    def forward(self, in_trees, out_trees):
        ...
        concat_embedding = fuse_embedding + pe * 0.5
        ...
        concat_embedding_o = fuse_embedding_o + pe_o * 0.5
